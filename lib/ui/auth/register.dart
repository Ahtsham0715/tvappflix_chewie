...
class _RegisterState extends State<Register> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      resizeToAvoidBottomInset: context.isPortrait ? false : null,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          focusedBorder: OutlineInputBorder(
                              ...
                              borderSide: BorderSide(
                                  color:
                                      (namevalide) ? Colors.white : Colors.red,
                                  width: 1)),
                          enabledBorder: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(5.0),
                              borderSide: BorderSide(
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          focusColor:
                              (!passwordvalide) ? Colors.red : Colors.white,
                          labelText: 'Password',
                          labelStyle: TextStyle(
                          ...
                          suffixIcon: Icon(
                            ...
                            size: 15,
                            color:
                                (!passwordvalide) ? Colors.red : Colors.white70,
                          ),
                        ),
                        style: TextStyle(
                        ...
                        onFieldSubmitted: (v) {
                          FocusScope.of(context)
                              .requestFocus(confirm_password_focus_node);
                      ...
                      TextFormField(
                        ...
                        keyboardType: TextInputType.visiblePassword,
                        decoration: InputDecoration(
                          focusColor: (!confirmpasswordvalide)
                              ? Colors.red
                              : Colors.white,
                          labelText: 'Password confirmation',
                          labelStyle: TextStyle(
                              color: (!confirmpasswordvalide)
                                  ? Colors.red
                                  : Colors.white),
                          focusedBorder: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(5.0),
