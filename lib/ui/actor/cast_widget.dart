          ...
          Container(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                border: (widget.posty == widget.active_y &&
                        widget.postx == widget.index)
                    ? Border.all(color: Colors.purple, width: 2)
                    : Border.all(width: 1, color: Colors.transparent),
                boxShadow: [
                  BoxShadow(
                      color: (widget.posty == widget.active_y &&
                              widget.postx == widget.index)
